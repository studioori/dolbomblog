...
const Header = () => {
  return (
    <header className="w-full py-6 px-4 border-b border-border/50 bg-card/80 backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">
              실버케어 <span className="text-gradient-warm">글쓰기 파트너</span>
            </h1>
            <p className="text-xs text-muted-foreground">어르신의 하루를 따뜻하게 전하세요</p>
          </div>
        </div>
