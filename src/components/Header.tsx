...
const Header = () => {
  return (
    <header className="w-full py-5 px-4 border-b border-border/40 bg-card/80 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-3xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-3 group cursor-pointer">
          <div className="w-11 h-11 rounded-2xl bg-gradient-forest flex items-center justify-center shadow-card transition-all duration-300 group-hover:shadow-elevated group-hover:scale-105">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gold-light border border-secondary/20 transition-all duration-300 hover:shadow-soft hover:scale-105 hover:border-secondary/40 cursor-default group">
